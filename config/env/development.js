...
module.exports = {
  db: {                                                     //DON"T MODIFY THE LINE BELOW
    uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI || "mongodb://unknown:12345@ds133136.mlab.com:33136/essential_validation", //|| 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/mean-dev',
    options: {},
