...
//TODO: this one needs to be modify, too many environments var we are not using

module.exports = {
  db: {
    uri: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://sysadmin:sysadmin@ds139844.mlab.com:39844/the5bgees',
    options: {
      user: '',
      pass: ''
    },
